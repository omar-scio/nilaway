...
func GobRegister() {
	...
	gob.RegisterName(nextStr(), annotation.TriggerIfNonNilPrestring{})
	gob.RegisterName(nextStr(), annotation.TriggerIfDeepNonNilPrestring{})
	gob.RegisterName(nextStr(), annotation.ConsumeTriggerTautologyPrestring{})
